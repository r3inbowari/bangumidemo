...
fun initupdatapre(context: Context, data: BookIndexclass,selectclass:Selectclass,start:Int,end:Int){
    ...
    if (data.pageindex != 0) {
        if (returnsultpre == null) {
            ...
            if (returnsult != null) {
                var list =
                    PagesizeUtil.txttolist(returnsult.content, context, fontsize, linesize)
...
fun InitMapupdata(context: Context, data: BookIndexclass) {
    ...
    if (data.pageindex != 0) {
        ...
        if (resultnow == null){
            toloadbookdatatopage(context, bookDetail, data.pageindex - 1,data, selectdata, start, end,true)
        }
        else{
        ...
        if (data.pageindex != bookDetail!!.list.size - 1) {
            if (resultnow == null) {
                toloadbookdatatopage(context, bookDetail, data.pageindex + 1, data, selectdata, start, end, false)
            }
                else{
...
fun Mapupdata(context: Context, data: BookIndexclass) {
    ...
    if (data.pageindex != 0) {
        ...
        var resultnow = Bookselect.selectbookdata(i, selectdata, data.pageindex - 1)
        if (resultnow == null){
            loadbookdatatopage(context, bookDetail, data.pageindex - 1,data, selectdata, start, end,true)
        }
        else{
    ...
    if (data.pageindex != bookDetail!!.list.size - 1) {
        if (resultnow == null)
        {
            loadbookdatatopage(context, bookDetail, data.pageindex + 1,data, selectdata, start, end,false)}
        else{
